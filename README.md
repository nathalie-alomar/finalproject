...
Out of all of the thermal traits, CTmin proved to be the one that diversified more with *Plethodon serratus* being the only species that is not in the *P.glutinosus* group and also being the only species with a higher CTmin value. This points to the fact that incorporating more data from species across all three groups might show a larger thermal signal than just the glutinousus group alone. 
